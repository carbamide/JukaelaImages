...
#define kActionSheetTitleFont           [UIFont fontWithName:@"Helvetica" size:18]
...
#define kActionSheetButtonFont          [UIFont fontWithName:@"Helvetica" size:20]
...
#define kAlertViewTitleFont             [UIFont fontWithName:@"Helvetica" size:20]
...
#define kAlertViewMessageFont           [UIFont fontWithName:@"Helvetica" size:18]
...
#define kAlertViewButtonFont            [UIFont fontWithName:@"Helvetica" size:18]
